// ======================================================================
// Test1P.v generated from TopDesign.cysch
// 07/28/2023 at 13:15
...
// IDAC_P4_v1_10(IDACRange=0, IDACValue=120, Polarity=1, Resolution=8, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=IDAC_P4_v1_10, CY_CONFIG_TITLE=IDACMod, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=cyCapsense:IDACMod, CY_INSTANCE_SHORT_NAME=IDACMod, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=10, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=true, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=cyCapsense_IDACMod, )
...
module CapSense_P4_v6_0_1 ;
    ...
    assign Net_1665 = Net_1664 | Net_1946;
	...
	cy_psoc3_pins_v1_10
		#(.id("78add33d-9a14-46c9-b4ec-1bc5ff3622c4/67bbdae9-6d7f-4909-bd9b-ee2616c651c8"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("78add33d-9a14-46c9-b4ec-1bc5ff3622c4/7611adc0-783c-42ac-866a-acd65d57cdc4"),
	...
	cy_connect_v1_0 cy_analog_virtualmux_1_connect(Net_2083, Net_1994);
...
module top ;
    ...
    CapSense_P4_v6_0_1 cyCapsense ();

	wire [0:0] tmpOE__cyLed_p43_net;
	wire [0:0] tmpFB_0__cyLed_p43_net;
	wire [0:0] tmpIO_0__cyLed_p43_net;
	wire [0:0] tmpINTERRUPT_0__cyLed_p43_net;
	electrical [0:0] tmpSIOVREF__cyLed_p43_net;

	cy_psoc3_pins_v1_10
		#(.id("b0530824-700c-4acf-a4fc-66d07f02d82f"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		cyLed_p43
		 (.oe(tmpOE__cyLed_p43_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__cyLed_p43_net[0:0]}),
		  .io({tmpIO_0__cyLed_p43_net[0:0]}),
		  .siovref(tmpSIOVREF__cyLed_p43_net),
		  .interrupt({tmpINTERRUPT_0__cyLed_p43_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__cyLed_p43_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__cyLed_p44_net;
	wire [0:0] tmpFB_0__cyLed_p44_net;
	wire [0:0] tmpIO_0__cyLed_p44_net;
	wire [0:0] tmpINTERRUPT_0__cyLed_p44_net;
	electrical [0:0] tmpSIOVREF__cyLed_p44_net;

	cy_psoc3_pins_v1_10
		#(.id("8fc835f8-0fd8-4ecc-ac93-9f1ecad7f232"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		cyLed_p44
		 (.oe(tmpOE__cyLed_p44_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__cyLed_p44_net[0:0]}),
		  .io({tmpIO_0__cyLed_p44_net[0:0]}),
		  .siovref(tmpSIOVREF__cyLed_p44_net),
		  .interrupt({tmpINTERRUPT_0__cyLed_p44_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__cyLed_p44_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__cyLed_p45_net;
	wire [0:0] tmpFB_0__cyLed_p45_net;
	wire [0:0] tmpIO_0__cyLed_p45_net;
	wire [0:0] tmpINTERRUPT_0__cyLed_p45_net;
	electrical [0:0] tmpSIOVREF__cyLed_p45_net;

	cy_psoc3_pins_v1_10
		#(.id("8201d681-c7b0-4b53-99b8-ca5ede3c88ad"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		cyLed_p45
		 (.oe(tmpOE__cyLed_p45_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__cyLed_p45_net[0:0]}),
		  .io({tmpIO_0__cyLed_p45_net[0:0]}),
		  .siovref(tmpSIOVREF__cyLed_p45_net),
		  .interrupt({tmpINTERRUPT_0__cyLed_p45_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__cyLed_p45_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    SCB_P4_v4_0_2 cyUart_p50_p51 (
        .clock(1'b0),
        .cts_in(1'b0),
        .interrupt(Net_3),
        .m_miso(1'b0),
	...
	wire [0:0] tmpOE__cyBuzzer_p55_net;
	wire [0:0] tmpFB_0__cyBuzzer_p55_net;
	wire [0:0] tmpIO_0__cyBuzzer_p55_net;
	wire [0:0] tmpINTERRUPT_0__cyBuzzer_p55_net;
	electrical [0:0] tmpSIOVREF__cyBuzzer_p55_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		cyBuzzer_p55
		 (.oe(tmpOE__cyBuzzer_p55_net),
		  .y({Net_32}),
		  .fb({tmpFB_0__cyBuzzer_p55_net[0:0]}),
		  .io({tmpIO_0__cyBuzzer_p55_net[0:0]}),
		  .siovref(tmpSIOVREF__cyBuzzer_p55_net),
		  .interrupt({tmpINTERRUPT_0__cyBuzzer_p55_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__cyBuzzer_p55_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__cySegA_p20_net;
	wire [0:0] tmpFB_0__cySegA_p20_net;
	wire [0:0] tmpIO_0__cySegA_p20_net;
	wire [0:0] tmpINTERRUPT_0__cySegA_p20_net;
	electrical [0:0] tmpSIOVREF__cySegA_p20_net;

	cy_psoc3_pins_v1_10
		#(.id("510add20-4af6-4e74-9b0b-5388cbc54de4"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		cySegA_p20
		 (.oe(tmpOE__cySegA_p20_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__cySegA_p20_net[0:0]}),
		  .io({tmpIO_0__cySegA_p20_net[0:0]}),
		  .siovref(tmpSIOVREF__cySegA_p20_net),
		  .interrupt({tmpINTERRUPT_0__cySegA_p20_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__cySegA_p20_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__cySegB_p21_net;
	wire [0:0] tmpFB_0__cySegB_p21_net;
	wire [0:0] tmpIO_0__cySegB_p21_net;
	wire [0:0] tmpINTERRUPT_0__cySegB_p21_net;
	electrical [0:0] tmpSIOVREF__cySegB_p21_net;

	cy_psoc3_pins_v1_10
		#(.id("266e6927-d981-44b8-bbea-140253bc5c25"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		cySegB_p21
		 (.oe(tmpOE__cySegB_p21_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__cySegB_p21_net[0:0]}),
		  .io({tmpIO_0__cySegB_p21_net[0:0]}),
		  .siovref(tmpSIOVREF__cySegB_p21_net),
		  .interrupt({tmpINTERRUPT_0__cySegB_p21_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__cySegB_p21_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__cySegC_p22_net;
	wire [0:0] tmpFB_0__cySegC_p22_net;
	wire [0:0] tmpIO_0__cySegC_p22_net;
	wire [0:0] tmpINTERRUPT_0__cySegC_p22_net;
	electrical [0:0] tmpSIOVREF__cySegC_p22_net;

	cy_psoc3_pins_v1_10
		#(.id("3430e69b-5f16-4378-babd-2e0429bdc609"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		cySegC_p22
		 (.oe(tmpOE__cySegC_p22_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__cySegC_p22_net[0:0]}),
		  .io({tmpIO_0__cySegC_p22_net[0:0]}),
		  .siovref(tmpSIOVREF__cySegC_p22_net),
		  .interrupt({tmpINTERRUPT_0__cySegC_p22_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__cySegC_p22_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__cySegD_p23_net;
	wire [0:0] tmpFB_0__cySegD_p23_net;
	wire [0:0] tmpIO_0__cySegD_p23_net;
	wire [0:0] tmpINTERRUPT_0__cySegD_p23_net;
	electrical [0:0] tmpSIOVREF__cySegD_p23_net;

	cy_psoc3_pins_v1_10
		#(.id("39ad4f8b-13da-45fa-ad1d-0ef376b7752e"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		cySegD_p23
		 (.oe(tmpOE__cySegD_p23_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__cySegD_p23_net[0:0]}),
		  .io({tmpIO_0__cySegD_p23_net[0:0]}),
		  .siovref(tmpSIOVREF__cySegD_p23_net),
		  .interrupt({tmpINTERRUPT_0__cySegD_p23_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__cySegD_p23_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__cySegE_p24_net;
	wire [0:0] tmpFB_0__cySegE_p24_net;
	wire [0:0] tmpIO_0__cySegE_p24_net;
	wire [0:0] tmpINTERRUPT_0__cySegE_p24_net;
	electrical [0:0] tmpSIOVREF__cySegE_p24_net;

	cy_psoc3_pins_v1_10
		#(.id("f45fd125-dd15-4992-bedc-94441f68dbdc"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		cySegE_p24
		 (.oe(tmpOE__cySegE_p24_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__cySegE_p24_net[0:0]}),
		  .io({tmpIO_0__cySegE_p24_net[0:0]}),
		  .siovref(tmpSIOVREF__cySegE_p24_net),
		  .interrupt({tmpINTERRUPT_0__cySegE_p24_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__cySegE_p24_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__cySegF_p25_net;
	wire [0:0] tmpFB_0__cySegF_p25_net;
	wire [0:0] tmpIO_0__cySegF_p25_net;
	wire [0:0] tmpINTERRUPT_0__cySegF_p25_net;
	electrical [0:0] tmpSIOVREF__cySegF_p25_net;

	cy_psoc3_pins_v1_10
		#(.id("639e149a-a359-4786-98ba-f0e24b47a7dc"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		cySegF_p25
		 (.oe(tmpOE__cySegF_p25_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__cySegF_p25_net[0:0]}),
		  .io({tmpIO_0__cySegF_p25_net[0:0]}),
		  .siovref(tmpSIOVREF__cySegF_p25_net),
		  .interrupt({tmpINTERRUPT_0__cySegF_p25_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__cySegF_p25_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__cySegG_p26_net;
	wire [0:0] tmpFB_0__cySegG_p26_net;
	wire [0:0] tmpIO_0__cySegG_p26_net;
	wire [0:0] tmpINTERRUPT_0__cySegG_p26_net;
	electrical [0:0] tmpSIOVREF__cySegG_p26_net;

	cy_psoc3_pins_v1_10
		#(.id("05077cf1-6c89-407c-a4de-fdd4e3b0ef82"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		cySegG_p26
		 (.oe(tmpOE__cySegG_p26_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__cySegG_p26_net[0:0]}),
		  .io({tmpIO_0__cySegG_p26_net[0:0]}),
		  .siovref(tmpSIOVREF__cySegG_p26_net),
		  .interrupt({tmpINTERRUPT_0__cySegG_p26_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__cySegG_p26_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__cyDigit1_p34_net;
	wire [0:0] tmpFB_0__cyDigit1_p34_net;
	wire [0:0] tmpIO_0__cyDigit1_p34_net;
	wire [0:0] tmpINTERRUPT_0__cyDigit1_p34_net;
	electrical [0:0] tmpSIOVREF__cyDigit1_p34_net;

	cy_psoc3_pins_v1_10
		#(.id("2fd6b25d-bb5c-4672-b862-b868e3cd9195"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		cyDigit1_p34
		 (.oe(tmpOE__cyDigit1_p34_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__cyDigit1_p34_net[0:0]}),
		  .io({tmpIO_0__cyDigit1_p34_net[0:0]}),
		  .siovref(tmpSIOVREF__cyDigit1_p34_net),
		  .interrupt({tmpINTERRUPT_0__cyDigit1_p34_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__cyDigit1_p34_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__cyDigit2_p35_net;
	wire [0:0] tmpFB_0__cyDigit2_p35_net;
	wire [0:0] tmpIO_0__cyDigit2_p35_net;
	wire [0:0] tmpINTERRUPT_0__cyDigit2_p35_net;
	electrical [0:0] tmpSIOVREF__cyDigit2_p35_net;

	cy_psoc3_pins_v1_10
		#(.id("55b9ffac-1b0f-4eca-8ea4-5028cfb8b235"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		cyDigit2_p35
		 (.oe(tmpOE__cyDigit2_p35_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__cyDigit2_p35_net[0:0]}),
		  .io({tmpIO_0__cyDigit2_p35_net[0:0]}),
		  .siovref(tmpSIOVREF__cyDigit2_p35_net),
		  .interrupt({tmpINTERRUPT_0__cyDigit2_p35_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__cyDigit2_p35_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__cyCol1_p03_net;
	wire [0:0] tmpFB_0__cyCol1_p03_net;
	wire [0:0] tmpIO_0__cyCol1_p03_net;
	wire [0:0] tmpINTERRUPT_0__cyCol1_p03_net;
	electrical [0:0] tmpSIOVREF__cyCol1_p03_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8d318d8b-cf7b-4b6b-b02c-ab1c5c49d0ba"),
		  ...
		  .input_buffer_sel(2'b00))
		cyCol1_p03
		 (.oe(tmpOE__cyCol1_p03_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__cyCol1_p03_net[0:0]}),
		  .io({tmpIO_0__cyCol1_p03_net[0:0]}),
		  .siovref(tmpSIOVREF__cyCol1_p03_net),
		  .interrupt({tmpINTERRUPT_0__cyCol1_p03_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__cyCol1_p03_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__cyCol2_p02_net;
	wire [0:0] tmpFB_0__cyCol2_p02_net;
	wire [0:0] tmpIO_0__cyCol2_p02_net;
	wire [0:0] tmpINTERRUPT_0__cyCol2_p02_net;
	electrical [0:0] tmpSIOVREF__cyCol2_p02_net;

	cy_psoc3_pins_v1_10
		#(.id("a8cc952d-a1f5-4df0-8c78-bee020df383f"),
		  .drive_mode(3'b101),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		cyCol2_p02
		 (.oe(tmpOE__cyCol2_p02_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__cyCol2_p02_net[0:0]}),
		  .io({tmpIO_0__cyCol2_p02_net[0:0]}),
		  .siovref(tmpSIOVREF__cyCol2_p02_net),
		  .interrupt({tmpINTERRUPT_0__cyCol2_p02_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__cyCol2_p02_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__cyCol3_p01_net;
	wire [0:0] tmpFB_0__cyCol3_p01_net;
	wire [0:0] tmpIO_0__cyCol3_p01_net;
	wire [0:0] tmpINTERRUPT_0__cyCol3_p01_net;
	electrical [0:0] tmpSIOVREF__cyCol3_p01_net;

	cy_psoc3_pins_v1_10
		#(.id("fb0616ba-295d-432a-951d-481548c8539a"),
		  .drive_mode(3'b101),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		cyCol3_p01
		 (.oe(tmpOE__cyCol3_p01_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__cyCol3_p01_net[0:0]}),
		  .io({tmpIO_0__cyCol3_p01_net[0:0]}),
		  .siovref(tmpSIOVREF__cyCol3_p01_net),
		  .interrupt({tmpINTERRUPT_0__cyCol3_p01_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__cyCol3_p01_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__cyCol4_p00_net;
	wire [0:0] tmpFB_0__cyCol4_p00_net;
	wire [0:0] tmpIO_0__cyCol4_p00_net;
	wire [0:0] tmpINTERRUPT_0__cyCol4_p00_net;
	electrical [0:0] tmpSIOVREF__cyCol4_p00_net;

	cy_psoc3_pins_v1_10
		#(.id("1fd99be5-f6d1-4d20-b64e-2d01d4cf6c90"),
		  .drive_mode(3'b101),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		cyCol4_p00
		 (.oe(tmpOE__cyCol4_p00_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__cyCol4_p00_net[0:0]}),
		  .io({tmpIO_0__cyCol4_p00_net[0:0]}),
		  .siovref(tmpSIOVREF__cyCol4_p00_net),
		  .interrupt({tmpINTERRUPT_0__cyCol4_p00_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__cyCol4_p00_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
